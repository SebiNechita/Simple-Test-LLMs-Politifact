...
def main():
    ...
    if all_trial_metrics:
        ...
        agg_file = f"{RESULTS_FOLDER}/conformal_results_aggregated_{args.nums_trials}trials_{timestamp}.csv"
        ...
        all_trials_file = f"{RESULTS_FOLDER}/conformal_results_all_trials_{args.nums_trials}trials_{timestamp}.csv"
